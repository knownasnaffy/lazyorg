...
func initMainKeybindings(g *gocui.Gui, av *views.AppView) error {
	mainKeybindings := []Keybind{
		...
		{'j', func(g *gocui.Gui, v *gocui.View) error { av.UpdateToPrevDay(g); return nil }},
		{';', func(g *gocui.Gui, v *gocui.View) error { av.UpdateToNextDay(g); return nil }},
		{'k', func(g *gocui.Gui, v *gocui.View) error { av.UpdateToNextTime(g); return nil }},
		{'l', func(g *gocui.Gui, v *gocui.View) error { av.UpdateToPrevTime(g); return nil }},
		...
		{'J', func(g *gocui.Gui, v *gocui.View) error { av.UpdateToPrevWeek(); return nil }},
		{':', func(g *gocui.Gui, v *gocui.View) error { av.UpdateToNextWeek(); return nil }},
